...
export const shoesModernKit: Kit = {
  ...
  assets: {
    ...
    'hero-1': {
      file: 'hero-1.jpg',
      alt: 'Featured sneaker on a bold background',
    },
    'hero-2': {
      file: 'hero-2.jpg',
      alt: 'Runner mid-stride wearing the collection',
    },
    editorial: {
      file: 'editorial.jpg',
      alt: 'Close-up of premium shoe craftsmanship',
    },
      ...
      sections: [
              ...
              slides: [
                {
                  ...
                  subheading: 'Engineered for comfort, built to stand out.',
                  cta_text: 'Shop now',
                  cta_url: '/products',
                  alignment: 'left',
                },
                {
                  ...
                  subheading: 'The drops everyone is talking about.',
                  cta_text: 'Explore',
              ...
              slides: [
                {
                  image: '@asset/hero-1',
                  eyebrow: 'موسم جديد',
                  heading: 'انطلق مع الموسم',
                  subheading: 'صُمّمت للراحة، وبُنيت لتتميّز.',
                  cta_text: 'تسوّق الآن',
                  cta_url: '/products',
                  alignment: 'right',
                },
                {
                  ...
                  heading: 'تحرّك بأسلوبك',
                  subheading: 'الإصدارات التي يتحدّث عنها الجميع.',
                  cta_text: 'اكتشف',
                  cta_url: '/collections/sale',
                  alignment: 'center',
                },
              ...
              items: [
                {
                  icon: 'truck',
                  title: 'Fast delivery',
                  description: 'Express shipping on every order.',
                },
                {
                  icon: 'refresh',
                  title: '30-day returns',
                  description: 'Changed your mind? Send it back free.',
                },
                {
                  icon: 'shield',
                  title: 'Secure checkout',
                  description: 'Protected, encrypted payments.',
                },
                {
                  icon: 'award',
                  title: 'Authentic',
              ...
              items: [
                {
                  icon: 'truck',
                  title: 'توصيل سريع',
                  description: 'شحن سريع لكل طلب.',
                },
                {
                  icon: 'refresh',
                  title: 'إرجاع 30 يوماً',
                  description: 'غيّرت رأيك؟ أعِده مجاناً.',
                },
                {
                  icon: 'shield',
                  title: 'دفع آمن',
                  description: 'مدفوعات محميّة ومشفّرة.',
                },
                {
                  icon: 'award',
                  title: 'أصلي',
                  description: 'منتجات أصلية 100% ومضمونة.',
                },
              ],
            },
          },
        },
        {
          ...
          content: {
            ...
            ar: {
              heading: 'وصل حديثاً',
              subheading: 'أحدث الإصدارات، وصلت للتو.',
              link_label: 'عرض الكل',
              link_url: '/products',
            },
          },
        },
        {
          ...
          content: {
            en: {
              ...
              heading: 'Engineered for comfort',
              body: 'Premium materials, responsive cushioning and a fit that moves with you — from the first step to the last mile.',
              cta_text: 'Discover the tech',
            },
            ar: {
              eyebrow: 'صُنعت لتدوم',
              heading: 'صُمّمت للراحة',
              body: 'خامات فاخرة، توسيد مرن، ومقاس يتحرّك معك — من الخطوة الأولى حتى آخر ميل.',
              cta_text: 'اكتشف التقنية',
            },
          },
        },
        {
          ...
          content: {
            en: {
              ...
              subheading: 'The pairs everyone is wearing.',
              link_label: 'Shop the collection',
            },
            ar: {
              heading: 'الأكثر مبيعاً',
              subheading: 'الأحذية التي يرتديها الجميع.',
        ...
        },
        {
          ...
          content: {
            en: {
              ...
              subheading: "Up to 40% off — don't miss out.",
              expired_text: 'The sale has ended',
            },
            ar: {
              heading: 'تخفيضات منتصف الموسم',
              subheading: 'خصم حتى 40% — لا تفوّت الفرصة.',
              expired_text: 'انتهت التخفيضات',
            },
          },
        },
        {
          ...
          content: {
            en: {
              ...
              items: [
                {
                  quote:
                    'Most comfortable sneakers I have ever owned. Worth every penny.',
                  author: 'Sarah M.',
                  role: 'Verified buyer',
                  avatar: '@asset/testi-1',
                  rating: 5,
                },
                {
                  quote:
                    'Fast shipping and the quality is unreal. Already ordered a second pair.',
                  author: 'Ahmed K.',
                  role: 'Verified buyer',
                  avatar: '@asset/testi-2',
                  rating: 5,
                },
                {
                  quote:
                    'Clean design, perfect fit. Exactly what I was looking for.',
                  author: 'Lena P.',
                  role: 'Verified buyer',
                  avatar: '@asset/testi-3',
                  rating: 4,
                },
              ],
            },
            ar: {
              ...
              items: [
                {
                  quote: 'أكثر حذاء مريح امتلكته على الإطلاق. يستحق كل قرش.',
                  author: 'سارة م.',
                  role: 'مشترٍ موثّق',
                  avatar: '@asset/testi-1',
                  rating: 5,
                ...
                {
                  quote: 'شحن سريع وجودة لا تُصدّق. طلبت زوجاً ثانياً بالفعل.',
                  author: 'أحمد ك.',
                  role: 'مشترٍ موثّق',
                  avatar: '@asset/testi-2',
                  rating: 5,
                ...
                {
                  quote: 'تصميم أنيق ومقاس مثالي. تماماً ما كنت أبحث عنه.',
                  author: 'لينا ب.',
                  role: 'مشترٍ موثّق',
                  avatar: '@asset/testi-3',
                  rating: 4,
        ...
        },
        {
          ...
          content: {
            en: {
              ...
              subheading: '#OurBrand in the wild',
              items: [
                { url: '@asset/gallery-1', alt: 'Street style 1' },
                { url: '@asset/gallery-2', alt: 'Street style 2' },
                { url: '@asset/gallery-3', alt: 'Street style 3' },
                { url: '@asset/gallery-4', alt: 'Street style 4' },
                { url: '@asset/gallery-5', alt: 'Street style 5' },
                { url: '@asset/gallery-6', alt: 'Street style 6' },
              ],
            },
            ar: {
              heading: 'في الشارع',
              subheading: '#علامتنا في كل مكان',
              items: [
                { url: '@asset/gallery-1', alt: 'ستايل 1' },
                { url: '@asset/gallery-2', alt: 'ستايل 2' },
                { url: '@asset/gallery-3', alt: 'ستايل 3' },
                { url: '@asset/gallery-4', alt: 'ستايل 4' },
                { url: '@asset/gallery-5', alt: 'ستايل 5' },
                { url: '@asset/gallery-6', alt: 'ستايل 6' },
              ],
            },
          },
        },
              ...
              items: [
                {
                  ...
                  answer:
                    'Check our size guide on each product page — most customers find their usual size fits true.',
                },
                {
                ...
                },
                {
                  ...
                  answer:
                    'Express shipping arrives in 2–5 business days depending on your location.',
                },
              ],
            },
            ar: {
              ...
              items: [
                {
                  question: 'كيف أعرف مقاسي؟',
                  answer:
                    'راجع دليل المقاسات في كل صفحة منتج — معظم العملاء يجدون مقاسهم المعتاد مناسباً.',
                },
                {
                  question: 'ما سياسة الإرجاع؟',
                  answer: 'إرجاع مجاني خلال 30 يوماً دون أي أسئلة.',
                },
                {
                  question: 'كم يستغرق الشحن؟',
                  answer: 'يصل الشحن السريع خلال 2–5 أيام عمل حسب موقعك.',
                },
              ],
            },
          },
        },
        {
          ...
          content: {
            en: {
              ...
              subheading: 'Get early access to drops and exclusive offers.',
              placeholder: 'your@email.com',
              button_label: 'Subscribe',
              success_message: "You're in — welcome!",
            },
            ar: {
              heading: 'انضم إلى النادي',
              subheading: 'احصل على وصول مبكر للإصدارات وعروض حصرية.',
              placeholder: 'your@email.com',
              button_label: 'اشترك',
              success_message: 'تم — أهلاً بك!',
            },
          },
        },
      ],
  ...
  demoData: {
    ...
    products: [
      {
        title: { en: 'Aero Runner', ar: 'إيرو رَنر' },
        base_price: 119,
        compare_at_price: 149,
        images: ['@asset/shoe-1'],
      },
      {
        title: { en: 'Street Classic', ar: 'ستريت كلاسيك' },
        base_price: 99,
        images: ['@asset/shoe-2'],
      },
      {
        title: { en: 'Trail Pro', ar: 'تريل برو' },
        base_price: 139,
        compare_at_price: 169,
        images: ['@asset/shoe-3'],
      },
      {
        title: { en: 'Court Low', ar: 'كورت لو' },
        base_price: 89,
        images: ['@asset/shoe-4'],
      },
    ],
