...
export const techMinimalKit: Kit = {
  ...
  assets: {
    ...
    'hero-1': {
      file: 'hero-1.jpg',
      alt: 'Flagship gadget on a clean backdrop',
    },
      ...
      sections: [
        {
          ...
          content: {
            en: {
              messages: [
                {
                  text: 'Free 2-day shipping · 1-year warranty on all devices',
                },
              ],
            },
            ar: {
              messages: [
                { text: 'شحن مجاني خلال يومين · ضمان سنة على كل الأجهزة' },
              ],
            },
          },
        },
    ...
    // ── HOME ────────────────────────────────────────────────
    {
      ...
      sections: [
              ...
              slides: [
                {
                  ...
                  heading: 'Tech that keeps up',
                  subheading: 'Powerful, refined, and built to last.',
                  cta_text: 'Shop new',
                  cta_url: '/products',
                  alignment: 'left',
                },
              ...
              slides: [
                {
                  image: '@asset/hero-1',
                  eyebrow: 'وصل حديثاً',
                  heading: 'تقنية تواكبك',
                  subheading: 'قوية، أنيقة، ومصمّمة لتدوم.',
                  cta_text: 'تسوّق الجديد',
                  cta_url: '/products',
                  alignment: 'right',
                },
              ],
              ...
              items: [
                {
                  icon: 'zap',
                  title: 'Fast charging',
                  description: 'Hours of power in minutes.',
                },
                {
                  icon: 'shield',
                  title: '1-year warranty',
                  description: 'Covered, every device.',
                },
                {
                  icon: 'truck',
              ...
              items: [
                {
                  icon: 'zap',
                  title: 'شحن سريع',
                  description: 'ساعات طاقة في دقائق.',
                },
                {
                  icon: 'shield',
                  title: 'ضمان سنة',
                  description: 'تغطية لكل جهاز.',
                },
                {
                  icon: 'truck',
                  title: 'شحن مجاني خلال يومين',
                  description: 'على كل طلب.',
                },
                {
                  icon: 'headphones',
                  title: 'دعم خبير',
                  description: 'بشر حقيقيون، 7 أيام أسبوعياً.',
                },
              ],
            },
          },
        },
        {
          ...
          content: {
            en: {
              ...
              subheading: 'The latest, in stock now.',
              link_label: 'View all',
              link_url: '/products',
            },
            ar: {
              heading: 'وصل حديثاً',
              subheading: 'الأحدث، متوفّر الآن.',
              link_label: 'عرض الكل',
              link_url: '/products',
            },
          },
        },
        {
          ...
          content: {
            en: {
              ...
              subheading: 'A 60-second look at what makes it different.',
            },
            ar: {
              heading: 'شاهده أثناء العمل',
              subheading: 'نظرة في 60 ثانية على ما يميّزه.',
            },
          },
        },
        {
          ...
          content: {
            en: {
              ...
              subheading: 'Loved by thousands.',
              link_label: 'Shop all',
            },
            ar: {
              heading: 'الأكثر مبيعاً',
              subheading: 'محبوب من الآلاف.',
              link_label: 'تسوّق الكل',
            },
          },
        },
        {
        ...
        },
        {
          ...
          content: {
            en: {
              heading: 'Trusted by tech lovers',
              items: [
                {
                  quote:
                    'Setup took two minutes and it just works. Battery life is incredible.',
                  author: 'Omar T.',
                  role: 'Verified buyer',
                ...
                {
                  quote:
                    'Premium build, fair price. The support team is fantastic too.',
                  author: 'Mia R.',
                  role: 'Verified buyer',
            ...
            ar: {
              heading: 'موثوق من عشّاق التقنية',
              items: [
                {
                  quote:
                    'الإعداد استغرق دقيقتين ويعمل ببساطة. عمر البطارية مذهل.',
                  author: 'عمر ت.',
                  role: 'مشترٍ موثّق',
                  avatar: '@asset/testi-1',
                  rating: 5,
                ...
                {
                  quote: 'تصنيع فاخر وسعر عادل. وفريق الدعم رائع أيضاً.',
                  author: 'ميا ر.',
                  role: 'مشترٍ موثّق',
                  avatar: '@asset/testi-2',
                  rating: 5,
              ...
              items: [
                {
                  ...
                  answer: 'Every device includes a 1-year limited warranty.',
                },
                {
                  question: 'Do you ship internationally?',
                  answer: 'Yes — to most countries, with tracked delivery.',
                },
                {
                  question: 'Can I return it?',
                  answer:
                    'Returns are accepted within 30 days, unused and in original packaging.',
                },
                {
                  question: 'Is support included?',
                  answer: 'Free expert support, 7 days a week.',
                },
              ],
            },
            ar: {
              ...
              items: [
                {
                  ...
                  answer: 'كل جهاز يشمل ضماناً محدوداً لمدة سنة.',
                },
                {
                  question: 'هل تشحنون دولياً؟',
                  answer: 'نعم — لمعظم الدول، مع شحن متتبَّع.',
                },
                {
                  question: 'هل يمكنني الإرجاع؟',
                  answer:
                    'يُقبل الإرجاع خلال 30 يوماً، غير مستخدم وبعبوته الأصلية.',
                },
                {
                  question: 'هل الدعم مشمول؟',
                  answer: 'دعم خبير مجاني، 7 أيام أسبوعياً.',
                },
              ],
            },
          },
        },
        {
          ...
          content: {
            en: {
              ...
              subheading: 'New drops and deals, straight to your inbox.',
              placeholder: 'your@email.com',
              button_label: 'Subscribe',
              success_message: 'Subscribed — talk soon!',
            },
            ar: {
              heading: 'ابقَ على اطّلاع',
              subheading: 'إصدارات وعروض جديدة، مباشرة إلى بريدك.',
              placeholder: 'your@email.com',
              button_label: 'اشترك',
              success_message: 'تم الاشتراك — إلى اللقاء!',
            },
          },
        },
      ],
  ...
  demoData: {
    ...
    products: [
      {
        title: { en: 'Pulse Earbuds', ar: 'سمّاعات بَلس' },
        base_price: 79,
        compare_at_price: 99,
        images: ['@asset/gadget-1'],
      },
      {
        title: { en: 'Vibe Speaker', ar: 'سمّاعة فايب' },
        base_price: 129,
        images: ['@asset/gadget-2'],
      },
      {
        title: { en: 'Track Watch', ar: 'ساعة تراك' },
        base_price: 159,
        compare_at_price: 189,
        images: ['@asset/gadget-3'],
      },
      {
        title: { en: 'Charge Pad', ar: 'لوح الشحن' },
        base_price: 39,
        images: ['@asset/gadget-4'],
      },
    ],
  },
};
