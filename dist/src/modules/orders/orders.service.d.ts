...
export declare class OrdersService {
    ...
    constructor(prisma: PrismaService, promotionsService: PromotionsService, shippingService: ShippingService);
    private readonly itemsWithProduct;
    private generateOrderNumber;
    create(userId: string, dto: CreateOrderDto): Promise<any>;
    findByCustomer(userId: string, page?: number, limit?: number): Promise<{
        data: ({
            items: ({
                product: ({
                    translations: {
    ...
    findByRole(userId: string, role: UserRole, page?: number, limit?: number): Promise<{
        data: ({
            customer: {
                id: string;
                created_at: Date;
    ...
    private resolveFulfillerId;
    private assertOwnsEntireOrder;
    updateStatus(id: string, dto: UpdateOrderStatusDto, actorId: string, actorRole: UserRole): Promise<{
        customer: {
            id: string;
            created_at: Date;
            updated_at: Date;
    ...
    updateFulfillment(orderId: string, itemId: string, dto: UpdateFulfillmentDto, actorId: string, actorRole: UserRole): Promise<{
        id: string;
        product_id: string | null;
        custom_product_id: string | null;
        variant_id: string | null;
