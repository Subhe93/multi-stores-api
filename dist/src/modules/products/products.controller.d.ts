...
export declare class ProductsController {
    ...
    findAll(page?: number, limit?: number, category_id?: string, product_type?: string, status?: ProductStatus, provider_id?: string, creator_id?: string, search?: string, is_featured?: string): Promise<{
        data: ({
            provider: {
                id: string;
                company_name: string;
