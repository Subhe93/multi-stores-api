...
export declare class PromotionsService {
    ...
    create(userId: string, userRole: UserRole, dto: CreatePromotionDto): Promise<{
        translations: {
            id: string;
    ...
    findByOwner(userId: string, userRole: UserRole, page?: number, limit?: number): Promise<{
        data: ({
            translations: {
                id: string;
                description: string | null;
    ...
    recordUsage(promotionId: string, orderId: string, userId: string, discountAmount: number): Promise<void>;
}
